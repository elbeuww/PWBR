...
---
*Last updated: 2026-06-14 — Milestone v1.0 (moteur analytique P1-4) clôturé et archivé ; milestone v2.0 « Plateforme publique » en cours, **Phases 1 et 2 complètes** : socle transverse i18n/RTL & rôles/gating (I18N-01..04, ACCESS-01..04 ; migrations 0008/0009/0010 live) + vitrine publique trilingue & gate légal (VITR-01/02/03, LEGAL-01/02 code ; 280/280 tests ; UAT humain restant = revue RTL + sign-off juriste). Cœur analytique livré (P1-4). Prochaine : Phase 3 (espace membre signaux gated RLS). Numérotation des phases reset à 1 ; roadmap v1.0 dans `.planning/archive/v1.0-moteur-analytique/`.*
