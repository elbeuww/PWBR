...
- [x] 08-03-PLAN.md — Santé : feux fraîcheur candles/news/macro + table job_runs + dashboard KPI [ADMIN-04]
- [x] 08-04-PLAN.md — Affiliés : perfs agrégées tables de base + wiring payouts existant [ADMIN-03]
**UI hint**: yes
...
- [x] 09-03-PLAN.md — présentation : composants pédago + mapping MDX + ContentCard + FilterBar + FallbackBanner [CMS-01]
- [x] 09-04-PLAN.md — routes RSC (index/article/cours/leçon via compileMDX) + sitemap hreflang + namespace i18n academy [CMS-01, CMS-02]
- [x] 09-05-PLAN.md — wiring funnel D-08 (nav/home/signal) + E2E + vérif rendu Vercel preview [CMS-01, LEGAL-01]
**UI hint**: yes
