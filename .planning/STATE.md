...
| 260701-1ib | Client Twelve Data remplace OANDA (token mort 401) comme source OHLCV forex+or : client fetch+Zod (throttle 8/min via pLimit(1), mapping _→/ et H1→1h), route oanda→TD dans market-ingest, migration 0022 désactive XAG/WTI (non couverts plan free). Smoke test réel : 29833 bougies, 5 forex/or frais, Binance intact. | 2026-07-01 | 931ebd4 | [260701-1ib](./quick/260701-1ib-client-twelve-data-remplace-oanda-forex-/) |
