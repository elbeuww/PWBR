/**
 * Tests du seuil d'affichage track record (TRACK-03, D-09/D-12).
 *
 * Vérifie : N≥30 → % affichable ; N<30 → insuffisant (aucun %) ; N=0 → état
 * honnête sans erreur ; N TOUJOURS présent dans les deux branches.
 */
...
describe('applyThreshold — seuil N≥30 (D-09/D-12)', () => {
  ...
  it('N=0 → insufficient, pas d’erreur, N=0', () => {
