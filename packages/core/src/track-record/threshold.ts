 ...
 *
 * SOURCE UNIQUE PARTAGÉE (D-11) : la vitrine P5 (apps/web re-export) ET le job
 * Telegram P6 (@app/core import direct) lisent ce MÊME seuil — cohérence stricte
 * vitrine ↔ Telegram, aucune duplication, aucun import cross-app jobs→web (D-49).
 */
